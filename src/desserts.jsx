...
const items=[
    {name:"Carrot And Mascarpone Cannelloni", cost:"₹345", description:"Phyllo pastry rolled into cannelloni stuffed with mascarpone cheese and gajjar ka hawla", image:"/images/i130.jpg", alt:"i130"},
];
    ...
    return(
        <div>
            ...
            <div style={{display:"flex"}}>
                ...
                <h3 className="menu-heading" style={{backgroundImage:'url(/images/i131.jpg)'}}>Desserts</h3>
