...
const items=[
    {name:"Grilled Peri Peri vegetable Sandwich", cost:"₹275", image:"/images/i99.jpg", alt:"i99"}
];
...
const Sandwitch=()=>{
    ...
    return(
        <div>
            ...
            <h3 className="menu-heading"  style={{backgroundImage:'url(/images/i100.jpg)'}}>Sandwiches</h3>
